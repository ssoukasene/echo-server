...
def client(msg, log_buffer=sys.stderr):
    ...
    sock = socket.socket()
    # cut and pasted above from the demo file, but these are the default options
    # so you dont' have to use any arguments
    ...
    try:
        ...
        sock.sendall(msg.encode()) # instead of sock.sendall(msg) because msg is a character string not a byte string
