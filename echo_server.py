...
def server(log_buffer=sys.stderr):
    ...
    # without the above the server port may not release port 10000
    ...
    sock.bind(address)
    sock.listen(1) # 1 tells it only one client can be waiting
    # if one client is waiting all others get rejected
        ...
        while True:
            ...
            try:
                ...
                while True:
                    ...
                    # alternatively could accumulate all the bytes then return the stream
